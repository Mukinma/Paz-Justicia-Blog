...
<head>
    ...
    <title>Política y Gobernanza - Peace in Progress</title>
...
<body>
    ...
    <!-- Hero principal -->
    <section class="hero-section" style="background-image: url('politica.jpg');">
        <div class="hero-content">
            <small> Categoria • 3 articulos</small>
            <h1>POLITICA Y GOBERNANZA</h1>
            <p>Programas públicos, leyes, elecciones y políticas para la paz. Esta sección analiza el rol del Estado en
                la construcción de sociedades más seguras y justas.
            </p>
        </div>
    </section>
