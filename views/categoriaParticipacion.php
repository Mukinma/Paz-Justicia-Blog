...
<head>
    ...
    <title>Participación Ciudadana - Peace in Progress</title>
...
<body>
    ...
    <!-- Hero principal -->
    <section class="hero-section" style="background-image: url('participacionciudadana.jpg');">
        <div class="hero-content">
            <small> Categoria • 3 articulos</small>
            <h1>PARTICIPACIÓN CIUDADANA</h1>
            <p>Desde el activismo juvenil hasta las comunidades organizadas, esta sección destaca formas en que la
                ciudadanía toma parte en la vida pública: protestas pacíficas, vigilancia social, iniciativas barriales
                y acciones digitales. Porque la democracia se fortalece cuando todas las voces cuentan.
            </p>
        </div>
    </section>
