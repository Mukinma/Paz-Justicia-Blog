...
<head>
    ...
    <title>Igualdad y Diversidad - Peace in Progress</title>
...
<body>
    ...
    <!-- Hero principal -->
    <section class="hero-section" style="background-image: url('diversidad.jpg');">
        <div class="hero-content">
            <small> Categoria • 3 articulos</small>
            <h1>IGUALDAD Y DIVERSIDAD</h1>
            <p>Aquí se reúnen las voces que luchan contra la discriminación y promueven una sociedad inclusiva. Porque
                una paz real solo existe cuando nadie queda fuera.
            </p>
        </div>
    </section>
