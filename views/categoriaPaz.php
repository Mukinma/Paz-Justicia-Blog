...
<head>
    ...
    <title>Paz y Conflictos - Peace in Progress</title>
...
<body>
    ...
    <!-- Hero principal -->
    <section class="hero-section" style="background-image: url('PAZ Y CONFLICTOS.jpg');">
        <div class="hero-content">
            <small> Categoria • 3 articulos</small>
            <h1>PAZ Y CONFLICTOS</h1>
            <p>Desde zonas de guerra hasta procesos de reconciliación, esta sección visibiliza los impactos de los
                conflictos y las iniciativas que apuestan por soluciones no violentas. La paz es un camino colectivo.
            </p>
        </div>
    </section>
