...
<head>
    ...
    <title>Corrupción y Transparencia - Peace in Progress</title>
...
<body>
    ...
    <!-- Hero principal -->
    <section class="hero-section" style="background-image: url('corrupcion.jpg');">
        <div class="hero-content">
            <small> Categoria • 3 articulos</small>
            <h1>CORRUPCIÓN Y TRANSPARENCIA</h1>
            <p>Investigaciones sobre corrupción, rendición de cuentas y reformas por un sistema justo y transparente. 
               Esta sección examina los desafíos para construir instituciones sólidas.
            </p>
        </div>
    </section>
